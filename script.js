...
function getPasswordOptions() {
  ...
  while (usroption !== '1' || usroption !== '2' || usroption !== '3' || usroption !== '4') {
  if (usroption != '1' && usroption != '2' && usroption != '3' && usroption != '4') {
      alert("You have not chosen Valid Password Option : " + usroption);
      var usroption = prompt(" Type Valid Password Option: 1=SpecialCharacters, 2=Numbers, 3=LowerCase Characters, 4=UpperCase Characters");
    }
  else if (usroption == '1') {

      alert("You have chosen Password Option: " + usroption + " for Special char");
      break;
    }
    else if (usroption == '2') {

      alert("You have chosen Password Option: " + usroption + " for Numeric char");
      break;
    }
    else if (usroption == '3') {

      alert("You have chosen Password Option: " + usroption + " for LowerCased char");
      break;
    }
    
    else if (usroption == '4') {

      alert("You have chosen Password Option: " + usroption + " for UpperCased char");
      break;
    }
  }
